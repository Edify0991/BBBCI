...
subpicpubsiger::subpicpubsiger() : it(nh)//, rtde_control("192.168.0.103"), rtde_receive("192.168.0.103")
{
    ...
    //定义手眼标定矩阵
    hand_eye << 0.03006123217543401, 0.9965115604339446, -0.00143988310270853, -0.01197427122384206,
                                -1.002049100011909, 0.02912875631300208, 0.01397067203070994, -0.08342061429085906,
                                0.02144551945917329, 0.001402180482763579, 1.000270098739843, 0.0122283855523366,
                                0, 0, 0, 1;
}
