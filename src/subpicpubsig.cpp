...
subpicpubsiger::subpicpubsiger() : it(nh)//, rtde_control("192.168.0.103"), rtde_receive("192.168.0.103")
{
    ...
    GripSig = nh.subscribe<std_msgs::Bool>("/GripSig", 1, &subpicpubsiger::GripSigCallback, this);
    ...
    //定义手眼标定矩阵
    hand_eye << 0.03220552832313333, 0.9994644233242707, -0.009112357027245261, -0.05272721310058739,
                                -0.9994802227650715, 0.03224943700194, 0.002054489478072477, -0.06392885246488189,
                                0.002361793340655025, 0.009038545229119805, 0.9999291988730086, 0.2257434579298642,
                                0, 0, 0, 1;
}
